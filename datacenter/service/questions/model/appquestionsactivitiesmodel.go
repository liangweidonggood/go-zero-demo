...
func (m *defaultAppQuestionsActivitiesModel) Insert(data AppQuestionsActivities) (sql.Result, error) {
	...
	ret, err := m.Exec(func(conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.Exec(query, data.Beid, data.Ptyid, data.Title, data.StartDate, data.EndDate, data.GetScore, data.ActivityWeek, data.Header, data.Des, data.Image, data.Rule, data.Status, data.CreatedAt, data.UpdatedAt)
...
func (m *defaultAppQuestionsActivitiesModel) Update(data AppQuestionsActivities) error {
	...
	_, err := m.Exec(func(conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.Exec(query, data.Beid, data.Ptyid, data.Title, data.StartDate, data.EndDate, data.GetScore, data.ActivityWeek, data.Header, data.Des, data.Image, data.Rule, data.Status, data.CreatedAt, data.UpdatedAt, data.Id)
