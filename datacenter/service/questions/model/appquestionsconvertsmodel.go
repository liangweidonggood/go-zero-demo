...
func (m *defaultAppQuestionsConvertsModel) Insert(data AppQuestionsConverts) (sql.Result, error) {
	...
	ret, err := m.ExecNoCache(query, data.Beid, data.Ptyid, data.Uid, data.Auid, data.LotteryId, data.Username, data.Phone, data.Status)
...
func (m *defaultAppQuestionsConvertsModel) Update(data AppQuestionsConverts) error {
	...
	_, err := m.Exec(func(conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.Exec(query, data.Beid, data.Ptyid, data.Uid, data.Auid, data.LotteryId, data.Username, data.Phone, data.Status, data.Id)
